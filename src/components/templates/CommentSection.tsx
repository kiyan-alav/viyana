    ...
    <div className="flex flex-col gap-8">
      ...
      >
        ...
        <Textarea
          ...
          label="پیام"
          isRequired
          errorMessage="لطفا نظر خود را وارد کنید"
          classNames={{
            inputWrapper: "h-max",
          }}
        />
      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm">
            طفاً مستندات را با دقت مطالعه کنید. طفاً مستندات را با دقت مطالعه
            کنید. طفاً مستندات را با دقت مطالعه کنید. طفاً مستندات را با دقت
            مطالعه کنید. طفاً مستندات را با دقت مطالعه کنید.{" "}
          </p>
        </div>
        <div className="flex flex-col gap-4">
          <div className="flex gap-2 items-center">
