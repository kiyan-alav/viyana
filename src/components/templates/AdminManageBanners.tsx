...
function AdminManageBanners() {
    ...
    const [bannerImgFile, setBannerImgFile] = useState<string | File | null>(null);
    const [bannerImgDisplay, setBannerImgDisplay] = useState<string | File | null>(null);
                                ...
                                <div className="">
                                    ...
                                    {bannerImgFile && (
                                        <div className="border border-solid rounded-lg w-36 h-24">
                                            <img src={bannerImgDisplay as string} alt="cateogory"
