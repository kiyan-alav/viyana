...
function AdminBannerItem() {
    ...
    return (
        <div className="block w-[250px] relative group">
            <div
                className="w-full group box-border overflow-hidden flex rounded-md cursor-pointer pb-2 lg:pb-3 flex-col items-start transition duration-200 ease-in-out transform hover:-translate-y-1 md:hover:-translate-y-1.5 hover:shadow-md bg-white border">
            ...
            <div
                className="absolute top-0 left-0 transition-all duration-300 ease-in-out bg-black/20 backdrop-blur w-full h-full rounded-md opacity-0 group-hover:opacity-100 flex items-center justify-center gap-6">
                <button className="text-white bg-red-600 rounded p-1" onClick={() => deleteMessageHandler("11")}>
