...
function AdminUsersTable() {
  const {
    ...
    onOpen: onOpenProductInfo,
    onOpenChange: onOpenChangeProductInfo,
  } = useDisclosure();
            ...
            <>
              ...
              <ModalBody className="flex flex-col gap-4">
                <div className="flex flex-col gap-4">
                  <h3 className="flex-1 text-palette-50 text-sm lg:text-base font-semibold">
                    جزئیات اقلام خریداری شده
                  </h3>
                  <div className="flex flex-col gap-4">
                    <div className="flex items-center">
                      <h4 className="flex-1 text-palette-50 text-sm lg:text-base font-medium">
                        نایک مشکی
                      </h4>
                      <p className="text-palette-50 text-sm lg:text-base">
                        $10.00
                      </p>
                    </div>
                    <div className="flex items-center">
