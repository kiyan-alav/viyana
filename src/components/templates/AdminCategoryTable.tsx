...
function AdminCategoryTable() {
    ...
    const [categoryImgFile, setCategoryImgFile] = useState<string | File | null>(null);
    const [categoryImgDisplay, setCategoryImgDisplay] = useState<string | File | null>(null);

    const onFileSelectCategoryImage = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        <div className="flex flex-col gap-4">
            ...
            <Modal isOpen={isOpen} onOpenChange={onOpenChange} size="sm">
                <ModalContent>
                    {(onClose) => (
                        <>
                            <ModalHeader className="flex flex-col gap-1">ویرایش یا افزودن دسته بندی</ModalHeader>
                                ...
                                <div className="">
                                    ...
                                    {categoryImgFile && (
                                        <div className="border border-solid rounded-lg w-36 h-24">
                                            <img src={categoryImgDisplay as string} alt="cateogory"
                                                 className="w-full h-full"/>
                                        </div>
                                    )}
                                    <input type="file" id="cateogory" className="hidden"
                                    ...
                                    <div className="mt-2">
                                        {categoryImgFile && (
                                            <label
                                                ...
                                                htmlFor="cateogory">
                                                جایگزینی پوستر
                                                <Icon icon="material-symbols:replace-image-outline" width="36"
                                                      height="36"/>
                                            </label>
                                        )}
                                    </div>
