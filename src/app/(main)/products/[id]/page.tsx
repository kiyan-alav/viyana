        ...
        <div className="col-span-2 md:col-span-1">
          <div className="">
            <div className="flex items-start justify-between">
              <h2 className="text-palette-50 text-lg md:text-xl lg:text-2xl 2xl:text-3xl font-bold hover:text-black mb-3.5">
                پسرانه قرمز مانیاک
              </h2>
              <div className="flex  gap-4 items-center">
                <div className="text-palette-50 font-bold text-base md:text-xl lg:text-2xl">
                  $40.00
                </div>
                <div className="line-through text-gray-400 text-sm md:text-base lg:text-lg">
                  $50.00
                </div>
              </div>
            </div>
            <ul className="my-4 space-y-4">
              ...
              <li>
                ...
                <span className="text-palette-100 font-semibold transition hover:underline hover:text-palette-50">
                  10
                </span>
              </li>
              <li>
                ...
                <p className="text-palette-100 font-semibold text-sm lg:text-base leading-6 lg:leading-8">
                  لباس کودکان/پوشاک کودکان معمولاً نسبت به لباس بزرگسالان
                  راحت‌تر است و مناسب بازی و استراحت است. معمولاً از جوراب
                  استفاده می‌شود. اخیراً، بسیاری از لباس‌های کودکان به شدت تحت
                  تأثیر روندهای مد بزرگسالان قرار گرفته‌اند
                </p>
              </li>
            </ul>
          </div>
          ...
          <div className="flex items-center gap-8 my-8">
            <div className="group flex items-center justify-between rounded-md overflow-hidden flex-shrink-0 border h-11 md:h-12 border-gray-300">
              ...
              <button className="flex items-center justify-center h-full flex-shrink-0 transition ease-in-out duration-300 focus:outline-none w-10 md:w-12 text-heading border-s border-gray-300 hover:text-white hover:bg-palette-50">
          ...
          <Accordion
            itemClasses={{
              heading:
                "text-sm font-bold text-palette-50 md:text-base lg:text-lg",
              content:
                "font-semibold pb-6 md:pb-7 leading-7 text-sm text-gray-600",
