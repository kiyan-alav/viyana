...
function ChangePassword() {
    ...
    const oldPasswordToggleVisibility = () => setIsVisibleOldPassword(prev => !prev);
    const newPasswordToggleVisibility = () => setIsVisibleNewPassword(prev => !prev);


    return (
        <div className="flex flex-col gap-4">
            <h2 className="text-lg md:text-xl xl:text-2xl font-bold text-palette-50">تغییر رمز عبور</h2>
